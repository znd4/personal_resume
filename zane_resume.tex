...
\begin{table}
	...
	\resumeRow{
		...
		\newline
		\newline
        I am a versatile software engineer with over 5 years of experience specializing in software development and machine learning. I'm currently attempting to upskill to be able to contribute to AI Safety research. Experienced in Python, I have moderate experience with Golang and Lua. As a senior engineer, I excel in leading high-level architectural discussions, collaborating with junior developers, and resolving complex issues. For those interested in \LaTeX, you can view the \href{https://github.com/znd4/personal_resume/blob/main/zane_resume.tex}{source code} for this resume on my GitHub repository.
	}
	\\
	\divider{EXPERIENCE}
	\\
