...
\begin{table}
    ...
    \resumeRow{
        ...
        I work on the modeling sub-team for Ford's Machine Learning platform. I work with the project manager and product owner to define developer enablement and feature development work. Helping my team embrace python best practices (e.g. pytest fixtures, fstrings, tox, pylint, black, poetry).
    }
    \\\vspace{.2cm}
    \resumeRow{
        \textbf{Ford Motor Company} \newline
