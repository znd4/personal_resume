...
\begin{table}
	...
	\resumeRow{
		...
		As the technical lead of the model-training-as-a-service product team within Ford's Mach1ML platform organization, I drove adoption of modern python development tools (\code{poetry}/\code{pipenv}, \code{black}, \code{pre-commit}, \code{tox}, etc).
		Championed the adoption of \code{fastapi} adding a \code{fastapi} wrapper to the team's project bootstrapping tool.
		Significantly sped up the process for the review \& approval of pypi packages.
		Planned cross-team integrations with other tech leads.
		Led the early development and design of the platform's python SDK\@.
		Oversaw the deployment of >10 ML products.
		Mentored a large (\textasciitilde{10}) team of junior developers \& data scientists.
	}
	\\\vspace{.2cm}
	\resumeRow{
		\textbf{Ford Motor Company} \newline
