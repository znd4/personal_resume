...
\begin{table}
    ...
    \resumeRow{
        ...
        Development work on Ford's Machine Learning platform.
        Improve development and deployment of modeling microservice in
        high performance computing kubernetes cluster. Integrated modeling microservice with
        data pipelines. Designed interface for the platform's python SDK. Designed pipeline
        for open-source python package approvals. Directly supported data science teams.
    }
    \\\vspace{.2cm}
    \resumeRow{
        \textbf{Ford Motor Company} \newline
