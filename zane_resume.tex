...
\begin{table}
    ...
    \resumeRow{
        ...
        Works with project manager and product owner of Ford's machine learning platform modeling sub-team to prioritize developer enablement and feature development. Standardized team's container image management process. Streamlined python-dependency management by switching from pip to \href{https://python-poetry.org/}{poetry}.
    }
    \\
    \resumeRow{
        \textbf{Ford Motor Company} \newline
