...
\begin{table}
    ...
    \resumeRow{
        ...
        Works with project manager and product owner of Ford's machine learning platform modeling sub-team to prioritize developer enablement and feature development. Helping team embrace python best practices (e.g. pytest fixtures, fstrings, tox, pylint, black, poetry).
    }
    \\
    \resumeRow{
        \textbf{Ford Motor Company} \newline
